...
export const PAGES = ["Dashboard","Option Score","OI Pulse","AI Signal","Backtest","Execution","Alerts","History","Money Mgt.","Calendar","MTF Confluence","Journal","Analytics","Options","Settings"];
